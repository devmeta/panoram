...
(function () {
  ...
  Webflow.define('brand', module.exports = function($) {
    ...
    var brandElement = (function() {
      ...
      var $logoArt = $('<img>')
      .attr('src', '/images/webflow-badge-icon.60efbf6ec9.svg')
      .css({
        marginRight: '8px',
        width: '16px',
      });
      ...
      var $logoText = $('<img>')
      .attr('src', '/images/webflow-badge-text.6faa6a38cd.svg');
...
Webflow.require('ix').init([
  {"slug":"toggle","name":"Toggle","value":{"style":{},"triggers":[{"type":"click","selector":".buttontoggle","descend":true,"preserve3d":true,"stepsA":[{"transition":"transform 500ms ease-in-out 0","x":"51px","y":"0px","z":"0px"}],"stepsB":[{"transition":"transform 500ms ease-in-out 0","x":"0px","y":"0px","z":"0px"}]},{"type":"click","selector":".buttontext-off","descend":true,"stepsA":[{"wait":"125ms"},{"opacity":0,"transition":"opacity 175ms ease 0"}],"stepsB":[{"wait":"100ms"},{"opacity":1,"transition":"opacity 175ms ease 0"}]},{"type":"click","selector":".togglebuttongreen","descend":true,"stepsA":[{"opacity":1,"transition":"opacity 500ms ease 0"}],"stepsB":[{"opacity":0,"transition":"opacity 500ms ease 0"}]}]}},
